...
<body style="background-image:url(img/fondo.png);background-repeat:repeat;" >
    ...
    <nav class="navbar navbar-default navbar-fixed-top topnav" >
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#" >EasyCar</a>
            </div>
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li>
                        <a class="color:#FF004E" target="_blank" href='SignUp/'>Log In/Sing Up</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="intro-message">
                        <h1 class="wow bounceInLeft">EasyCar</h1>
    ...
    <!-- Footer -->
    <footer style="background-image:url(img/fondo.png);background-repeat:repeat;">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
