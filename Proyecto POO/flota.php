                        ...
                        <div id="carousel-example-generic" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="carousel-inner" role="listbox">
                                ...
                                <div class="item active">
                                    <img class="slide-image" src="img/chevrolet.jpg" alt="Flota">
                                </div>

                                <div class="item">
                                    <img class="slide-image" src="img/mitsubishi.jpg" alt="Flota2">
                                </div>

                                <div class="item">
                                    <img class="slide-image" src="img/honda.jpg" alt="">
                                </div>
