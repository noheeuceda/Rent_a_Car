	  ...
	  <div class="container-fluid">
	    ...
	    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        ...
	        <li class="dropdown">
	          <a class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Clientes <span class="caret" class="active"></span></a>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="col-lg-6">
				...
				<div >
					<table id="div-reservaciones">
					</table>
				 <button type="button"  class="btn btn-warning" data-dismiss="modal" href="#" data-toggle="modal" data-target="#agregar">Agregar Reservacion</button>
